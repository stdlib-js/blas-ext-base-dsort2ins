...
```javascript
dsort2ins = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsort2ins@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsort2ins@umd/bundle.js"></script>
```
